...
import com.mj.admin.service.RoleService;
...
import com.mj.common.tools.CollectionUtils;
import com.mj.common.tools.DateUtil;
import com.mj.dao.entity.Role;
import com.mj.dao.entity.RoleResource;
...
public class RoleSerivceImpl implements RoleService {
    ...
    public RestResult add(Map map) {
        System.out.println("进入添加server");
        // 角色\资源 信息
        String ukName = (String) map.get("ukName");
        String remark = (String) map.get("remark");
        List<Integer> menus = (List<Integer>) map.get("menus");
        Integer cityId = Integer.valueOf(String.valueOf(map.get("cityId")));
