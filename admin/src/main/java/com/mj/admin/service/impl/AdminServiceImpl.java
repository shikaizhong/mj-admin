...
import com.mj.admin.constants.ParamConstant;
import com.mj.admin.exceptions.APIRunTimeException;
import com.mj.admin.exceptions.RoleNotExistException;
import com.mj.admin.params.AdminRequest;
import com.mj.admin.params.AdminUpdateRequest;
import com.mj.admin.redis.JWTRedisDAO;
import com.mj.admin.service.AdminService;
import com.mj.common.enums.ResultCodeEnum;
import com.mj.common.result.PageResult;
...
public class AdminServiceImpl implements AdminService {
    ...
    public RestResult login(Map map) {
        ...
        domain.put(AdminConstant.ACCOUNT, admin.getUkAccount());
    ...
    public RestResult logout(String authorization) {
        ...
        if (StringUtil.isEmpty((String) params.get(AdminConstant.ACCOUNT))){
            return ResultUtils.error(ResultCodeEnum.ILLEGAL_ARGUMENT.getCode(),ResultCodeEnum.ILLEGAL_ARGUMENT.getMsg());
        }
        // 更新 redis token
        jwtRedisDAO.delete(AdminConstant.JWT_TOKEN+params.get(AdminConstant.ACCOUNT));
...
//        adminMapper.updateByPrimaryKey(admin);
    ...
    public RestResult getAdmin(String type, String keys) {
        ...
        }else if (AdminConstant.ACCOUNT.equals(type)){
