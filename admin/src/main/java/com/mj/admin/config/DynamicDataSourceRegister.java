...
///**
// * 动态数据源注册
// * 实现importBeanDefinitionRegistrar实现数据源注册
// * 实现environmentAware用于读取application.yml配置
// */
...
//        // 获取其他数据源配置
//        List<Map> configs = binder.bind("spring.datasource.other", Bindable.listOf(Map.class)).get();
//        // 遍历从数据源
